...
<br/>
리액트 공식 문서에서 제공하는 ErrorBoundary 컴포넌트 코드를 살펴보겠습니다.
<br/>
```tsx
...
```
<br/>
잊고 지내던 클래스형 컴포넌트가 나와 당황스럽습니다 😓
에러 처리와 관련된 라이프 사이클 메서드를 대신할 hook이 없기 때문에 ErrorBoundary는 클래스형 컴포넌트로 만들어야 한다고 합니다.
<br/>
...
<br/>
에러와 관련된 라이프 사이클 메서드도 알아보았으니 이제 ErrorBoundary 컴포넌트 코드를 천천히 살펴보겠습니다.
<br/>

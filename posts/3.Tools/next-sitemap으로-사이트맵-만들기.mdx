...
#### 🚨에러 발생 (24.09.10)
<br/>
포스트 작성 후 배포한 뒤 사이트맵이 잘 업데이트 되었나 확인했습니다. 그런데 전혀 업데이트 되어있지 않았습니다. 미처 삭제하지 않은 public 폴더 내의 사이트맵 파일 때문인가 싶어 삭제 후 다시 배포했지만 이번엔 아예 사이트맵이 생성되지 않았습니다😨 
...
이 부분에 대해서 추가적으로 알게 되는게 있다면 바로 업데이트해두겠습니다.
<br/>
### 확인
<br/>

...
describe("Tag 컴포넌트 단위 테스트", () => {
  ...
  it("props를 전달하지 않으면 default props가 적용된다.", () => {
    render(<Divider />);
  ...
  it("className prop으로 전달한 class 이름이 적용된다.", () => {
